> [!WARNING]
> Here is the short announcement about the discontinuation and the transfer of ownership.  
> To read the reasons for discontinuation and the future of these projects, you will fint the explanations linked in [my OpenDesktop topic](https://forum.opendesktop.org/t/i-officially-discontinue-the-suru-icons-theme-i-accept-the-transfer-of-repositories-to-anyone-interested/21239) or in [REASON.md](./REASON.md).
